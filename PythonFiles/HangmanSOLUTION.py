...
def getLetter(guessedLetters):
    ...
    while True:    
        ...
        if len(letter) != 1:
            print('You did not enter a single alphabetical character. Please try again.')
        elif letter.isalpha() == False:
            print('Letter is not alphabetic')
        elif letter in guessedLetters:
            #In this worked solution, I've used an f-string. Alternate names include
            #string interpolation. f-strings are a useful string formatting tool.
            print(f'You have guessed this letter "{letter}" already. Try again.')
        else:
            return letter
...
def playAgain():
    ...
    while True:
        ...
        if choice.startswith('n'):
            ...
            print('Please type "Yes" or "No", "Y" or "N"')
